...
aptUserModule.component('user', {
    ...
    controller: ['$http', 'userService', 'validateAddUserErrorCode', 'userGroupService', '$scope', '$q',
        function ($http, userService, errorMsg, userGroupService, $scope, $q) {
            var socket = io();
            ...
            deferred.promise.then(function (data) {
                self.userOnline.push(data);
                console.log(self.userOnline);
            });
        }
    ]
});
